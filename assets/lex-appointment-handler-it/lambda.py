...
You can ask an IT Support question e.g. "Where is the IT Help Desk?"
Text "Schedule" to schedule an appointment with IT Support."""
    ...
    if source == "DialogCodeHook":
        ...
        if not vaccine_type:
            return helpers.elicit_slot(
                ...
                "VaccineType",
                {
                    ...
                    "content": "Sure thing! What type of laptop repair appointment would you like to schedule?",
                },
                helpers.build_response_card(
                    "Specify Appointment Type",
                    "What type of laptop repair appointment would you like to schedule?",
        ...
        if (vaccine_type and full_name) and not test_result:
            return helpers.elicit_slot(
                ...
                {
                    "contentType": "PlainText",
                    "content": "In the past 7 days, have you installed any new Software? Please reply (Yes/No) ",
                },
            )
        ...
        if (vaccine_type and full_name and test_result) and not contact_result:
            return helpers.elicit_slot(
                ...
                {
                    "contentType": "PlainText",
                    "content": "In the past 7 days, is your laptop got damaged? Please reply (Yes/No) ",
                },
            )
        ...
        if (
            ...
            return helpers.elicit_slot(
                ...
                {
                    "contentType": "PlainText",
                    "content": "Do you currently have problem in booting the laptop or connecting to the network? Please reply (Yes/No) ",
                },
            )
